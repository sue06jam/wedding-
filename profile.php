...
<body id="page-top">
  ...
  <!--/ Intro Skew Star /-->
  <div id="home" class="intro route bg-image" style="background-image: url(img/malupiton.jpg)">
...
<div class="container">
  ...
  <section id="service" class="services-mf route mt-4">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
           <a href="photo.php">
           <div class="service-box" style="background-image:url(img/6.jpg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
  ...
  <div class="section-counter paralax-mf bg-image" style="background-image: url(img/malupiton.jpg)">
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    <ul class="list-ico">
                      ...
                      <li><span class="ion-ios-telephone"></span> 095413274890</li>
