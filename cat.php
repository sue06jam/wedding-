...
<div id="#das">
 <h2 class="text-center">Catering Details</h2>
  ...
  <section class="paralax-mf footer-paralax bg-image sect-mt4 route" style="background-image: url(img/malupiton.jpg)">
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    <ul class="list-ico">
                      ...
                      <li><span class="ion-ios-telephone"></span> 09541327489</li>
